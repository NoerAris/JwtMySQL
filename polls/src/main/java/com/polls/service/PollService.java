...
import com.polls.exception.BadRequestException;
...
import com.polls.payload.PollRequest;
import com.polls.payload.PollResponse;
import com.polls.payload.VoteRequest;
...
import com.polls.util.ModelMapper;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
        ...
        Map<Long, MasterUser> creatorMap = getPollCreatorMap(polls.getContent());
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        Map<Long, Long> choiceVoteCountMap = getChoiceVoteCountMap(pollIds);
        Map<Long, Long> pollUserVoteMap = getPollUserVoteMap(currentUser, pollIds);
        Map<Long, MasterUser> creatorMap = getPollCreatorMap(polls);
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        MasterUser creator = userRepository.findById(poll.getCreatedBy())
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        MasterUser user = userRepository.getOne(currentUser.getId());
    ...
    Map<Long, MasterUser> getPollCreatorMap(List<Poll> polls) {
        ...
        List<MasterUser> creators = userRepository.findByIdIn(creatorIds);
        Map<Long, MasterUser> creatorMap = creators.stream()
                .collect(Collectors.toMap(MasterUser::getId, Function.identity()));
